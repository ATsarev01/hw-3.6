...
public class StudentControllerTest {
    ...
    public void putTest() {
        ...
        assertThat(getForEntityResponse.getBody()).usingRecursiveComparison()
                .isEqualTo(student);
        ...
        assertThat(recordResponseEntity.getBody()).usingRecursiveComparison()
                .isEqualTo(student);
    ...
    private Student generateStudent(Faculty faculty) {
        ...
        student.setAge(faker.random().nextInt(12, 19));
        if (faculty != null) {
